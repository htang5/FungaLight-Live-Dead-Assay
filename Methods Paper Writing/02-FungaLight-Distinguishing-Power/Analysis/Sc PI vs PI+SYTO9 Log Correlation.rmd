...
combined_data$new_FGS <- 1*combined_data$percent_Live - combined_data$percent_inter - combined_data$percent_Dead
pf1g <- combined_data %>%
  ...
  facet_wrap(~ Treatment, nrow = 1, labeller = as_labeller(c("0" = "0 mM", "0.6" = "0.6 mM", "6" = "6 mM", "1000" = "1000 mM"))) +
...
#("../output/20240301-Cg-Log-Gated_.png", width = 7, height = 5)
```
